...
With no probes it runs a default radio/identity batch. A probe ending in `?` captures context help; a probe
without `?` is executed normally (newline) and its output captured.
"""
import argparse
import sys
import time
